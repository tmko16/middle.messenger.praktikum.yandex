...
export class RegistrationPage extends Block {
    ...
    constructor() {
        ...
        this.setChildren({
            ...
            login: new FormInput({label: "Логин", name: "login", type: "text", validation: passwordValidation}),
            first_name: new FormInput({label: "Имя", name: "first_name", type: "text", validation: nameValidation}),
            second_name: new FormInput({label: "Фамилия", name: "second_name", type: "text", validation: nameValidation}),
            phone: new FormInput({label: "Телефон", name: "phone", type: "text", validation: phoneValidation}),
            password: new FormInput({label: "Пароль", name: "password", type: "password", validation: passwordValidation}),
        })
    }
